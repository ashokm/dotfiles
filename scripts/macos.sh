...
open "$(pwd)/config/terminal/ashokm.terminal" -a Terminal.app
sleep 1
defaults write com.apple.Terminal "Default Window Settings" "ashokm"
defaults write com.apple.Terminal "Startup Window Settings" "ashokm"
